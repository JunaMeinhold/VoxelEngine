...
namespace HexaEngine.Windows.Native
{
    ...
    public struct Rect
    {
        ...
        public Rect(ComRect r) : this(r.Left, r.Top, r.Right, r.Bottom)
        {
        }
        ...
        public static implicit operator Rect(ComRect r) => new(r);
        ...
        public override bool Equals(object obj)
        {
            ...
            else if (obj is ComRect rectangle2)
                return Equals(new Rect(rectangle2));
            return false;
        }
