namespace HexaEngine.Input.RawInput.Native
{
    ...
    {
        private readonly RawMouseFlags usFlags;
        private readonly ushort usReserved;
        private readonly RawMouseButtonFlags usButtonFlags;
        private readonly short usButtonData;
        private readonly uint ulRawButtons;
        private readonly int lLastX;
        private readonly int lLastY;
