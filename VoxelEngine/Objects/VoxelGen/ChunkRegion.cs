namespace HexaEngine.Objects.VoxelGen
{
    ...
    public struct ChunkRegion
    {
        ...
        public void Generate(World world)
        {
            ...
            ToDisk(Chunks[0].Map, false);
        }

        public ChunkState GetState(WorldMap map)
        {
            var result = ExistOnDisk(map);
            if (result && State == ChunkState.None)
                return ChunkState.OnDisk;
            else
                return State;
        }
        ...
        public void ToDisk(WorldMap world, bool dispose = true)
        {
