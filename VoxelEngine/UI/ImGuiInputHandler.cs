...
namespace VoxelEngine.UI
{
    internal class ImGuiInputHandler
    {
        ...
        {
            ImGuiIOPtr io = ImGui.GetIO();
            int index = e.MouseButton switch
            {
                MouseButton.None => -1,
                MouseButton.Left => 0,
                MouseButton.Right => 1,
        ...
        public void Update()
        {
            ...
            ImGuiMouseCursor mouseCursor = ImGui.GetIO().MouseDrawCursor ? ImGuiMouseCursor.None : ImGui.GetMouseCursor();
        ...
        public bool UpdateMouseCursor()
        {
            ...
            ImGuiMouseCursor requestedcursor = ImGui.GetMouseCursor();
            ...
            {
                SystemCursor cursor = SystemCursor.SystemCursorArrow;
