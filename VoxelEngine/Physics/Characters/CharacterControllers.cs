...
namespace VoxelEngine.Physics.Characters
{
    /// <summary>
        ...
        private void AnalyzeContactsForCharacterRegion(int start, int exclusiveEnd, int workerIndex)
        {
            ...
            for (int characterIndex = start; characterIndex < exclusiveEnd; ++characterIndex)
            {
                ...
                if (bodyLocation.SetIndex == 0)
                {
                    ...
                    {
                        QuaternionEx.Transform(character.LocalUp, Simulation.Bodies.ActiveSet.SolverStates[bodyLocation.Index].Motion.Pose.Orientation, out Vector3 characterUp);
                        ...
                        float characterUpVelocity = Vector3.Dot(Simulation.Bodies.ActiveSet.SolverStates[bodyLocation.Index].Motion.Velocity.Linear, characterUp);
                        ...
                        if (character.Support.Mobility != CollidableMobility.Static)
                        {
                            ...
                            ref BodyVelocity supportVelocity = ref Simulation.Bodies.ActiveSet.SolverStates[supportingBodyLocation.Index].Motion.Velocity;
                    ...
                    else if (supportCandidate.Depth > float.MinValue)
                    {
                        ...
                        QuaternionEx.Transform(character.LocalUp, Simulation.Bodies.ActiveSet.SolverStates[bodyLocation.Index].Motion.Pose.Orientation, out Vector3 up);
