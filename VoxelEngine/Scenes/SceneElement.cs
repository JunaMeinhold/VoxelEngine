namespace VoxelEngine.Scenes
{
    ...
    public class SceneElement
    {
        ...
        /// The children.
        /// </value>
        public List<SceneElement> Children { get; } = new();
        ...
        /// Called by <see cref="Scene.Add(SceneElement)"/> if <see cref="Scene.initialized"/> == <see langword="true" /><br/>
        /// </summary>
        ...
        /// Called by <see cref="Scene.Remove(SceneElement)"/> if <see cref="Scene.initialized"/> == <see langword="true" /><br/>
        /// </summary>
        ...
        /// Calls <see cref="Scene.Remove(SceneElement)"/> param <see cref="this"/><br/>
        /// </summary>
        public void Destroy()
        {
            Scene.Remove(this);
