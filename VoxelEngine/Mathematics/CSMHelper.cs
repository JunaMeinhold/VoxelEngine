namespace VoxelEngine.Mathematics
{
    ...
    public static class CSMHelper
    {
        ...
        {
            Matrix4x4.Invert(projview, out Matrix4x4 inv);
        ...
        public static Matrix4x4 GetLightSpaceMatrix(Matrix4x4 viewProj, Transform transform)
        {
            ...
            for (int i = 0; i < corners.Length; i++)
            {
                Vector4 trf = Vector4.Transform(corners[i], lightView);
        ...
        public static void GetLightSpaceMatrices(Matrix4x4[] ret, float[] cascades, CameraTransform camera, Transform light, int cascadesCount = 3)
        {
