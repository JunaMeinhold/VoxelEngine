...
namespace HexaEngine.Editor
{
    ...
    using BoundingFrustum = VoxelEngine.Mathematics.BoundingFrustum;
    using BoundingSphere = VoxelEngine.Mathematics.BoundingSphere;
    ...
    public static unsafe class DebugDraw
    {
        ...
        public static void DrawBoundingBox(string id, BoundingBox box, Vector4 col)
        {
            ...
            if (queue.Draw(id, PrimitiveTopology.LineList, 24, vertexCount, out DebugDrawCommand cmd))
            {
                ...
                ZeroMemoryT(cmd.Vertices, vertexCount);
            }
...
24,56,
        ...
        public static void DrawBoundingBox(object name, BoundingBox boundingBox, Vector4 vector4)
        {
